// Package ConfluxJoin
// Dafny module ConfluxJoin compiled into Go
...
func (_static *CompanionStruct_Default___) JoinCheckpoint(combine func(interface{}, interface{}, m_ConfluxContract.Option) interface{}, primary _dafny.Map, side _dafny.Map) _dafny.Map {
	return func() _dafny.Map {
		var _coll0 = _dafny.NewMapBuilder()
		_ = _coll0
		for _iter2 := _dafny.Iterate((primary).Keys().Elements()); ; {
			...
			if (primary).Contains(_0_k) {
				_coll0.Add(_0_k, (combine)(_0_k, (primary).Get(_0_k).(interface{}), (func() m_ConfluxContract.Option {
					if (side).Contains(_0_k) {
						return m_ConfluxContract.Companion_Option_.Create_Some_((side).Get(_0_k).(interface{}))
					}
