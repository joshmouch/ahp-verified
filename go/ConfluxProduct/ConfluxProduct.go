// Package ConfluxProduct
// Dafny module ConfluxProduct compiled into Go
...
func (*Default__) String() string {
	return "ConfluxProduct.Default__"
}
...
func (_static *CompanionStruct_Default___) Product(r1 func(interface{}, interface{}) interface{}, r2 func(interface{}, interface{}) interface{}) func(_dafny.Tuple, interface{}) _dafny.Tuple {
	return (func(_0_r1 func(interface{}, interface{}) interface{}, _1_r2 func(interface{}, interface{}) interface{}) func(_dafny.Tuple, interface{}) _dafny.Tuple {
		return func(_2_s _dafny.Tuple, _3_a interface{}) _dafny.Tuple {
			return _dafny.TupleOf((_0_r1)((*(_2_s).IndexInt(0)), _3_a), (_1_r2)((*(_2_s).IndexInt(1)), _3_a))
		}
	})(r1, r2)
}
