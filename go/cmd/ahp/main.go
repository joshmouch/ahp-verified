...
import (
	...
	m_ConfluxContentLength "github.com/joshmouch/ahp-verified/go/ConfluxContentLength"
	...
	m_ConfluxHttpService "github.com/joshmouch/ahp-verified/go/ConfluxHttpService"
	m_ConfluxJoin "github.com/joshmouch/ahp-verified/go/ConfluxJoin"
	m_ConfluxJsonRpc "github.com/joshmouch/ahp-verified/go/ConfluxJsonRpc"
	...
	m_ConfluxSequence "github.com/joshmouch/ahp-verified/go/ConfluxSequence"
...
var _ m_ConfluxContentLength.Dummy__

func main() {
	defer _dafny.CatchHalt()
	m_ClientMain.Companion_Default___.Main(_dafny.UnicodeFromMainArguments(os.Args))
}
