// Class ChatAction_CDelta
// Dafny class ChatAction_CDelta compiled into Java
package agency.open.ahp.Chat;

@SuppressWarnings({"unchecked", "deprecation"})
public class ChatAction_CDelta extends ChatAction {
  ...
  public ChatAction_CDelta (dafny.DafnySequence<? extends dafny.CodePoint> turnId, dafny.DafnySequence<? extends dafny.CodePoint> partId, dafny.DafnySequence<? extends dafny.CodePoint> content) {
    super();
    this._turnId = turnId;
    this._partId = partId;
  ...
  public boolean equals(Object other) {
    ...
    ChatAction_CDelta o = (ChatAction_CDelta)other;
  ...
  public String toString() {
    ...
    s.append("Chat.ChatAction.CDelta");
    s.append("(");
