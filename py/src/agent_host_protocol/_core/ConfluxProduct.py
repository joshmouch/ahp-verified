...
class default__:
    ...
    @staticmethod
    def Product(r1, r2):
        def lambda0_(d_0_r1_, d_1_r2_):
            def lambda1_(d_2_s_, d_3_a_):
                return (d_0_r1_((d_2_s_)[0], d_3_a_), d_1_r2_((d_2_s_)[1], d_3_a_))

            return lambda1_

        return lambda0_(r1, r2)
