use crate::dafny_runtime::DafnyPrint;
...
macro_rules! impl_dafnyint_from {
    () => {};
    ($type:ident) => {
        impl ::std::convert::From<$type> for $crate::dafny_runtime::DafnyInt {
            fn from(n: $type) -> Self {
                $crate::dafny_runtime::DafnyInt {
                    data: $crate::dafny_runtime::Rc::new(n.into()),
                }
            }
        }
        #[allow(trivial_numeric_casts)]
        impl $crate::dafny_runtime::DafnyUsize for $type {
